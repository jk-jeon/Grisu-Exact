...
namespace jkj {
	namespace grisu_exact_detail {
		...
		struct common_info {
			...
			static constexpr int min_k = -floor_log10_pow2(max_exponent + 1 - alpha) - max_kappa;
		...
		struct cache_holder<double> {
			static constexpr uint128 cache[] = {
				...
				{ 0x8fd0c16206306bab, 0xa5d3b6d479f8e057 },
				{ 0xb3c4f1ba87bc8696, 0x8f48a4899877186d },
				{ 0xe0b62e2929aba83c, 0x331acdabfe94de88 },
				{ 0x8c71dcd9ba0b4925, 0x9ff0c08b7f1d0b15 },
				{ 0xaf8e5410288e1b6f, 0x07ecf0ae5ee44dda },
				{ 0xdb71e91432b1a24a, 0xc9e82cd9f69d6151 },
				{ 0x892731ac9faf056e, 0xbe311c083a225cd3 },
				{ 0xab70fe17c79ac6ca, 0x6dbd630a48aaf407 },
				{ 0xd64d3d9db981787d, 0x092cbbccdad5b109 },
				{ 0x85f0468293f0eb4e, 0x25bbf56008c58ea6 },
				{ 0xa76c582338ed2621, 0xaf2af2b80af6f24f },
				{ 0xd1476e2c07286faa, 0x1af5af660db4aee2 },
				{ 0x82cca4db847945ca, 0x50d98d9fc890ed4e },
				{ 0xa37fce126597973c, 0xe50ff107bab528a1 },
	...
	template <class Float>
	struct bit_representation_t : private grisu_exact_detail::common_info<Float>
	{
	private:
	...
	namespace grisu_exact_detail {
		template <class Float, class RoundingModeArgs, class CorrectRoundingSearchArgs>
		struct grisu_exact_args :
			private bit_representation_t<Float>,
			private RoundingModeArgs,
			private CorrectRoundingSearchArgs
		{
			using extended_significand_type =
				typename grisu_exact_detail::common_info<Float>::extended_significand_type;

			template <class RoundingModeArgsParam, class CorrectRoundingSearchArgsParam>
			grisu_exact_args(bit_representation_t<Float> br,
				RoundingModeArgsParam&& rounding_mode_args,
				CorrectRoundingSearchArgsParam&& crg_args) :
				bit_representation_t<Float>(br),
				RoundingModeArgs(std::forward<RoundingModeArgsParam>(rounding_mode_args)),
				CorrectRoundingSearchArgs(std::forward<CorrectRoundingSearchArgsParam>(crg_args)) {}

			extended_significand_type bit_representation() const noexcept {
				return static_cast<bit_representation_t<Float> const&>(*this).f;
			}

			RoundingModeArgs& rounding_mode_args() noexcept {
				return static_cast<RoundingModeArgs&>(*this);
			}
			RoundingModeArgs const& rounding_mode_args() const noexcept {
				return static_cast<RoundingModeArgs const&>(*this);
			}

			CorrectRoundingSearchArgs& correct_rounding_search_args() noexcept {
				return static_cast<CorrectRoundingSearchArgs&>(*this);
			}
			CorrectRoundingSearchArgs const& correct_rounding_search_args() const noexcept {
				return static_cast<CorrectRoundingSearchArgs const&>(*this);
			}
		};
	}
	...
	namespace grisu_exact_correct_rounding {
		...
		struct do_not_care {
			template <class Float, class RoundingMode, class RoundingModeArgs>
			signed_fp_t<Float> operator()(bit_representation_t<Float> br,
				RoundingMode&& rounding_mode, RoundingModeArgs&& rounding_mode_args) const
			{
				using arg_type = grisu_exact_detail::grisu_exact_args<Float,
					std::remove_cvref_t<RoundingModeArgs>, arguments::do_not_care>;

				return grisu_exact_detail::grisu_exact_impl<Float>::compute(
					arg_type{ br, std::forward<RoundingModeArgs>(rounding_mode_args),
					arguments::do_not_care{} });
			}
		};

		// Perform correct rounding search; tie to left
		struct tie_to_up {
			template <class Float, class RoundingMode, class RoundingModeArgs>
			signed_fp_t<Float> operator()(bit_representation_t<Float> br,
				RoundingMode&& rounding_mode, RoundingModeArgs&& rounding_mode_args) const
			{
				using arg_type = grisu_exact_detail::grisu_exact_args<Float,
					std::remove_cvref_t<RoundingModeArgs>, arguments::tie_to_up>;
		...
		// Perform correct rounding search; tie to right
		struct tie_to_down {
			template <class Float, class RoundingMode, class RoundingModeArgs>
			signed_fp_t<Float> operator()(bit_representation_t<Float> br,
				RoundingMode&& rounding_mode, RoundingModeArgs&& rounding_mode_args) const
			{
				using arg_type = grisu_exact_detail::grisu_exact_args<Float,
					std::remove_cvref_t<RoundingModeArgs>, arguments::tie_to_down>;

				return grisu_exact_detail::grisu_exact_impl<Float>::compute(
					arg_type{ br, std::forward<RoundingModeArgs>(rounding_mode_args),
					arguments::tie_to_down{} });
			}
		};
	}
	...
	namespace grisu_exact_rounding_modes {
		namespace arguments {
			...
			struct to_nearest_closed {
				static constexpr tag_t	tag = to_nearest_tag;
				static constexpr bool	include_left_endpoint = true;
				static constexpr bool	include_right_endpoint = true;
			};
			struct to_nearest_open {
				static constexpr tag_t	tag = to_nearest_tag;
				static constexpr bool	include_left_endpoint = false;
				static constexpr bool	include_right_endpoint = false;
			};
			struct to_nearest_left_closed_right_open {
				static constexpr tag_t	tag = to_nearest_tag;
				static constexpr bool	include_left_endpoint = true;
				static constexpr bool	include_right_endpoint = false;
			};
			struct to_nearest_left_open_right_closed {
				static constexpr tag_t	tag = to_nearest_tag;
				static constexpr bool	include_left_endpoint = false;
				static constexpr bool	include_right_endpoint = true;
			};
		...
		struct nearest_to_even {
			template <class Float, class CorrectRoundingSearch>
			signed_fp_t<Float> operator()(bit_representation_t<Float> br,
				CorrectRoundingSearch&& crg) const
			{
				return std::forward<CorrectRoundingSearch>(crg)(br, *this,
					arguments::to_nearest{ br.f % 2 == 0, br.f % 2 == 0 });
			}
		};
		...
		struct nearest_toward_plus_infinity {
			...
			{
				// For positive
				if ((br.f & grisu_exact_detail::common_info<Float>::sign_bit_mask) == 0)
				{
					return std::forward<CorrectRoundingSearch>(crg)(br, *this,
						arguments::to_nearest{ false, true });
				}
				// For negative
				else {
					return std::forward<CorrectRoundingSearch>(crg)(br, *this,
						arguments::to_nearest{ true, false });
				}
			}
		};
		...
		struct nearest_toward_zero {
			...
			{
				return std::forward<CorrectRoundingSearch>(crg)(br, *this,
					arguments::to_nearest_left_closed_right_open{});
			}
		};
		...
		struct nearest_away_from_zero {
			...
			{
				return std::forward<CorrectRoundingSearch>(crg)(br, *this,
					arguments::to_nearest_left_open_right_closed{});
			}
		};
		
		// Same as nearest_to_even, but generate separate codes for
		// different boundary conditions; may produce faster code, but bigger binary
		struct nearest_to_even_static_boundary {
				...
				CorrectRoundingSearch&& crg) const
			{
				if (br.f % 2 == 0) {
					return std::forward<CorrectRoundingSearch>(crg)(br, *this,
						arguments::to_nearest_closed{});
				}
				else {
					return std::forward<CorrectRoundingSearch>(crg)(br, *this,
						arguments::to_nearest_open{});
				}
			}
		};
		...
		struct toward_plus_infinity {
				...
				CorrectRoundingSearch&& crg) const
			{
				...
				{
					return std::forward<CorrectRoundingSearch>(crg)(br, *this,
						arguments::right_closed_directed{});
				}
				// For negative
				else {
					return std::forward<CorrectRoundingSearch>(crg)(br, *this,
						arguments::left_closed_directed{});
				}
			}
		};
	...
	namespace grisu_exact_detail {
		...
		struct compute_mul_helper : public common_info<Float>
		{
			...
			template <grisu_exact_rounding_modes::arguments::tag_t tag>
			static extended_significand_type compute_delta(bool is_edge_case,
				cache_entry_type const& cache, int minus_beta)
			{
				...
				if constexpr (tag == grisu_exact_rounding_modes::arguments::to_nearest_tag)
				{
					if (is_edge_case)
						r = (r >> 1) + (r >> 2);

					return extended_significand_type(
						r >> (intermediate_precision - q_mp_m1 + minus_beta));
				}
				// For left-directed rounding
				else if constexpr (tag == grisu_exact_rounding_modes::arguments::left_closed_directed_tag)
				{
					return extended_significand_type(
						r >> (intermediate_precision - q_mp_m1 + minus_beta));
				}
				// For right-directed rounding
					...
					if (is_edge_case) {
						return extended_significand_type(
							r >> (intermediate_precision - (q_mp_m1 - 1) + minus_beta));
					}
					else {
						return extended_significand_type(
							r >> (intermediate_precision - q_mp_m1 + minus_beta));
		...
		public:
			...
			template <class RoundingModeArgs, class CorrectRoundingSearchArgs>
			static signed_fp_t<Float> compute(
				grisu_exact_args<Float, RoundingModeArgs, CorrectRoundingSearchArgs> const& args)
			{
				signed_fp_t<Float> ret_value;

				ret_value.is_negative = (args.bit_representation() & sign_bit_mask) != 0;
				auto significand = args.bit_representation() << (extended_precision - precision - 1);

				auto exponent = int((args.bit_representation() << 1) >> (precision + 1));
				...
				// For nearest rounding
				if constexpr (RoundingModeArgs::tag ==
					grisu_exact_rounding_modes::arguments::to_nearest_tag)
				{
					fr = significand | boundary_bit;
				}
				// For left-closed directed rounding
				else if constexpr (RoundingModeArgs::tag ==
					grisu_exact_rounding_modes::arguments::left_closed_directed_tag)
				{
				...
				auto deltai = compute_delta<RoundingModeArgs::tag>(
					significand == sign_bit_mask, cache, minus_beta);

				// These are needed for correct rounding search
				auto steps = compute_delta<grisu_exact_rounding_modes::arguments::left_closed_directed_tag>(
					false, cache, minus_beta + 1);
				auto approx_y = zi - steps;
				...
				bool did_increasing_search;
				if (r < deltai) {
					goto increasing_search_label;
				}
				else if (r == deltai) {
					if (is_zf_smaller_than_deltaf(significand, minus_beta, cache,
						args.rounding_mode_args(), exponent, minus_k))
					{
				...
				did_increasing_search = false;
				
				// Perform binary search
				if constexpr (sizeof(Float) == 4) {
					decreasing_search<1>(ret_value, args.rounding_mode_args(), zf_vs_deltaf,
						exponent, minus_k, minus_beta, significand, deltai, r, cache);
				}
				else {
					decreasing_search<1>(ret_value, args.rounding_mode_args(), zf_vs_deltaf,
						exponent, minus_k, minus_beta, significand, deltai, r, cache);
			...
			increasing_search_label:
				did_increasing_search = true;

				// Perform binary search
				if constexpr (sizeof(Float) == 4) {
					increasing_search<4>(ret_value, args.rounding_mode_args(), zf_vs_deltaf,
						exponent, minus_k, minus_beta, significand, deltai, r, divisor, cache);
					increasing_search<2>(ret_value, args.rounding_mode_args(), zf_vs_deltaf,
						exponent, minus_k, minus_beta, significand, deltai, r, divisor, cache);
					increasing_search<1>(ret_value, args.rounding_mode_args(), zf_vs_deltaf,
						exponent, minus_k, minus_beta, significand, deltai, r, divisor, cache);
				}
				else {
					increasing_search<8>(ret_value, args.rounding_mode_args(), zf_vs_deltaf,
						exponent, minus_k, minus_beta, significand, deltai, r, divisor, cache);
					increasing_search<4>(ret_value, args.rounding_mode_args(), zf_vs_deltaf,
						exponent, minus_k, minus_beta, significand, deltai, r, divisor, cache);
					increasing_search<2>(ret_value, args.rounding_mode_args(), zf_vs_deltaf,
			...
			boundary_adjustment_and_return_label:
				...
				if (!args.rounding_mode_args().include_right_endpoint && r == 0) {
					static constexpr integer_check_case_id case_id =
						RoundingModeArgs::tag == grisu_exact_rounding_modes::arguments::to_nearest_tag ?
					...
					if (is_product_integer<case_id>(fr, exponent, minus_k)) {
						...
						while (true) {
							if (divisor < deltai)
								...
								if constexpr (std::is_same_v<std::remove_cvref_t<RoundingModeArgs>,
									grisu_exact_rounding_modes::arguments::to_nearest>)
								{
									if (!args.rounding_mode_args().include_left_endpoint &&
										is_delta_integer<RoundingModeArgs::tag>(significand == sign_bit_mask, exponent))
									{
										ret_value.significand *= 10;
										divisor /= 10;
										--ret_value.exponent;
				...
				if constexpr (CorrectRoundingSearchArgs::tag !=
					grisu_exact_correct_rounding::arguments::do_not_care_tag &&
					RoundingModeArgs::tag !=
					grisu_exact_rounding_modes::arguments::right_closed_directed_tag)
				{
					// Restore kappa
					auto kappa = ret_value.exponent - minus_k;

					deltai -= r;

					if (!did_increasing_search) {
						if (kappa == 1)
							r /= 10;
					}
					if (r >= steps)
					...
					bool should_check_fractional = true;
					if (kappa > 9) {
						should_check_fractional = (steps % power_of_10<9> == 0);
						steps /= power_of_10<9>;
						kappa -= 9;
					}

					auto case_handler = [&steps, &should_check_fractional](auto power_of_10_holder) {
						static constexpr extended_significand_type p =
							power_of_10<decltype(power_of_10_holder)::value>;
						if constexpr (CorrectRoundingSearchArgs::tag ==
							grisu_exact_correct_rounding::arguments::tag_t::tie_to_down_tag)
						{
							// Tie-to-down
							steps += (p / 2);
						}
							...
							// Tie-to-up
							if (steps < p / 2) {
								steps = extended_significand_type(-1);
								should_check_fractional = false;
								return;
							}
							
							steps -= (p / 2);
						}
						should_check_fractional = (should_check_fractional && ((steps % p) == 0));
						steps /= p;
					};

					switch (kappa) {
					case 1:
						case_handler(std::integral_constant<unsigned int, 1>{});
						break;
					case 2:
						case_handler(std::integral_constant<unsigned int, 2>{});
						break;
					case 3:
						case_handler(std::integral_constant<unsigned int, 3>{});
						break;
					case 4:
						case_handler(std::integral_constant<unsigned int, 4>{});
						break;
					case 5:
						case_handler(std::integral_constant<unsigned int, 5>{});
						break;
					case 6:
						case_handler(std::integral_constant<unsigned int, 6>{});
						break;
					case 7:
						case_handler(std::integral_constant<unsigned int, 7>{});
						break;
					case 8:
						case_handler(std::integral_constant<unsigned int, 8>{});
						break;
					case 9:
						case_handler(std::integral_constant<unsigned int, 9>{});
						break;
					}

					if constexpr (CorrectRoundingSearchArgs::tag ==
						grisu_exact_correct_rounding::arguments::tag_t::tie_to_up_tag)
					{
						++steps;
					}

					if (should_check_fractional) {
					...
					while (true) {
						if (divisor * steps < deltai) {
							break;
						}
						else if (divisor * steps == deltai) {
							switch (zf_vs_deltaf) {
		...
		private:
			...
			static bool is_product_integer(extended_significand_type f, int exponent, int minus_k)
			{
				...
				// Case IV or V: f = fc or fc +- 2^(q-p-1)
				else {
					// Exponent for 2 is positive
					if (exponent < integer_check_exponent_lower_bound_for_q_mp_m1) {
						assert(minus_k - exponent >= 1);
						// Perhaps better to utilize TZCNT?
						if (minus_k - exponent >= extended_precision)
							return false;
						return f == ((f >> (minus_k - exponent)) << (minus_k - exponent));
					}
			...
			template <class RoundingModeArgs>
			static bool is_zf_smaller_than_deltaf(extended_significand_type fc, int minus_beta,
				cache_entry_type const& cache, RoundingModeArgs& rounding_mode_args, int exponent, int minus_k)
			{
				// Compute fl
				extended_significand_type fl;
				if constexpr (RoundingModeArgs::tag ==
				...
				return is_zf_strictly_smaller_than_deltaf(fl, minus_beta, cache) ||
					(rounding_mode_args.include_left_endpoint &&
						equal_fractional_parts<RoundingModeArgs::tag>(fl, exponent, minus_k));
			}				
			...
			template <extended_significand_type lambda, class RoundingModeArgs>
			static bool increasing_search(
				signed_fp_t<Float>& ret_value,
				RoundingModeArgs& rounding_mode_args,
				zf_vs_deltaf_t& zf_vs_deltaf,
				int exponent, int minus_k, int minus_beta,
				extended_significand_type fc,
				extended_significand_type deltai,
				...
				cache_entry_type const& cache)
			{
				...
				if (deltai < new_r)
					...
					case zf_vs_deltaf_t::not_compared_yet:
						if (!is_zf_smaller_than_deltaf(fc, minus_beta, cache,
							rounding_mode_args, exponent, minus_k))
						{
							zf_vs_deltaf = zf_vs_deltaf_t::zf_larger;
							return false;
						}
		...
		template <class Float, class RoundingMode, class CorrectRoundingSearch>
		struct dispatcher :
			private bit_representation_t<Float>,
			...
			private CorrectRoundingSearch
		{
			...
			dispatcher(bit_representation_t<Float> br,
				RoundingModeParam&& rounding_mode, CorrectRoundingSearchParam&& crg) :
				bit_representation_t<Float>(br),
				RoundingMode(std::forward<RoundingModeParam>(rounding_mode)),
				CorrectRoundingSearch(std::forward<CorrectRoundingSearchParam>(crg)) {}
	...
	namespace grisu_exact_case_handlers {
		...
		auto get_bit_representation(Dispatcher&& dispatcher) noexcept
			-> bit_representation_t<typename std::remove_cvref_t<Dispatcher>::float_type> const&
		{
	...
	template <class Float,
		...
		class CorrectRoundingSearch = grisu_exact_correct_rounding::tie_to_down
	>
	auto grisu_exact(Float x,
		CaseHandler&& case_handler = {},
		RoundingMode&& rounding_mode = {},
		CorrectRoundingSearch&& crg = {}) ->
		decltype(case_handler(std::declval<grisu_exact_detail::dispatcher<Float,
			std::remove_cvref_t<RoundingMode>, std::remove_cvref_t<CorrectRoundingSearch>>>()))
	{
		bit_representation_t<Float> br;
		std::memcpy(&br.f, &x, sizeof(Float));

		return case_handler(grisu_exact_detail::dispatcher<Float,
			std::remove_cvref_t<RoundingMode>, std::remove_cvref_t<CorrectRoundingSearch>>{
			br, std::forward<RoundingMode>(rounding_mode), std::forward<CorrectRoundingSearch>(crg)
		});
	}
}
